...
import stylesCss from 'themes/helloworld/styles.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_helloworld_componentCss']) {
    
    document['_vaadintheme_helloworld_componentCss'] = true;
  }
